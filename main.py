...
with col2:
    s_vitals = st.text_input("S - Vitals (BP/HR/SpO2 血壓/心跳/血氧)", "BP 88/54, HR 108, SpO2 92% on SM”)
    t_treatment = st.text_input("T - Treatment given (處置)", "IV 18G Established | aspirin PO / 300mg | NTG SL / Withheld (SBP < 90)")
