...
with st.expander("📄 View Academic Abstract"):
    ...
    **Results:** Based on the SEIPS 2.0 system and PETT framework, we mapped the MIST and SBAR protocols into a localized HACCP matrix to enable proactive hazard prevention.
    """)
