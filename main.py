...
st.markdown("""
    <div class="patient-banner">
        ...
        <b>[DIAGNOSIS 診斷]</b> Suspected STEMI with  
            \n Early Cardiogenic Shock (疑似心肌梗塞及早期休克)<br>
...
with st.expander("📚 View References"):
    st.markdown("""
    1. **Altuwaijri EA, Budgen D, Maxwell S.** Factors impeding the effective utilisation of an electronic patient report form during handover from an ambulance to an emergency department. *Health Informatics J.* 2019 Dec;25(4):1705–21.\.<br>
    2. **Nuernberger M, Lang S, Maass T, Lehmann T, Brodoehl S, Lewejohann JC.** The Effects of an ISOBAR-Structured Patient Handover Conversation Between Rescue Services and Emergency Department Staff: The COPTER Trial. *J Am Coll Emerg Physicians Open.* 2025 Feb;6(1):100011.<br>
    3. **Poranen A, Kouvonen A, Nordquist H.** Human errors in emergency medical services: a qualitative analysis of contributing factors. *Scand J Trauma Resusc Emerg Med.* 2024 Aug 30;32(1):78.<br>
    4. **Schardt C, Adams MB, Owens T, Keitz S, Fontelo P.** Utilization of the PICO framework to improve searching PubMed for clinical questions. *BMC Med Inform Decis Mak.* 2007 Jun 15;7:16.<br>
    5. **Matthew J Page, Joanne E McKenzie, Patrick M Bossuyt, Isabelle Boutron, Tammy C Hoffmann, Cynthia D Mulrow, Larissa Shamseer, Jennifer M Tetzlaff, Elie A Akl, Sue E Brennan, Roger Chou, Julie Glanville, Jeremy M Grimshaw, Asbjørn Hróbjartsson, Manoj M Lalu, Tianjing Li, Elizabeth W Loder, Evan Mayo-Wilson, Steve McDonald, Luke A McGuinness, Lesley A Stewart, James Thomas, Andrea C Tricco, Vivian A Welch, Penny Whiting, David Moher.** (2021). The PRISMA 2020 statement: an updated guideline for reporting systematic reviews. *BMJ.*<br> 
    6. **Hong QN, Pluye P, et al.** Mixed Methods Appraisal Tool (MMAT), version 2018. *Registration of Copyright*. 2018;1148825.<br>
    7. **Whittemore R, Knafl K.** The integrative review: updated methodology. *Journal of Advanced Nursing.* 2005 Dec;52(5):546–53.<br>
    8. **World Health Organization.** Prehospital emergency care: operational guidance for ambulance systems by WHO [Report] [Internet]. *Geneva: World Health Organization; 2025.* Available from: https://www.who.int/publications/i/item/9789240114067<br>
    9. **Bryan FL** HACCP Present Status and Future in Contribution to Food Safety. [Internet]. [cited 2026 Jul 12]. Available from: https://www.foodprotection.org/members/fpt-archive-articles/1994-11haccp-present-status-and-future-in-contribution-to-food-safety/<br>
    10.**Alwidyan MT, Al Ruwaithi AA, Alrawashdeh A, Bashier H, Al-Smeiat M, Ikhwayleh ZA, et al.** Challenges Faced by Jordan’s Search and Rescue Team in the 2023 Turkey Earthquake; A Qualitative Study from Readiness to Response. *Arch Acad Emerg Med.* 2025;13(1):e80.
    """, unsafe_allow_html=True)
    
# 網頁最底端安全簽章（Footer）
st.write("---")
st.markdown("<p style='text-align: center; font-size: 11px; color: #95A5A6; font-family: sans-serif;'>© 2026 PERIC Project P-09. Developed for Academic Evaluation and Technical Audit Only. Full paper under review by Journal of Paramedicine and Emergency Response (JPER)</p>", unsafe_allow_html=True)
